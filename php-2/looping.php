...
foreach ($numbers as $value) {
    $rest[] = $value%=5;
        ...
        */
        ...
        foreach ($items as $currentArray) {
            $data = [
                "id" => $currentArray[0],
                "Nama" => $currentArray[1],
                "Harga" => $currentArray[2],
                "Deskripsi" => $currentArray[3],
                "Gambar" => $currentArray[4]
            ];
            print_r($data);
            echo "<br>";
        }
